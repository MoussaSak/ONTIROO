...
public interface JavaVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link JavaParser#myClassName}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMyClassName(JavaParser.MyClassNameContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link JavaParser#myMethodName}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMyMethodName(JavaParser.MyMethodNameContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link JavaParser#myVariableName}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMyVariableName(JavaParser.MyVariableNameContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link JavaParser#myPackageName}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMyPackageName(JavaParser.MyPackageNameContext ctx);
	/**
